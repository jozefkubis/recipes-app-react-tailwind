      ...
      <form className="flex space-x-2 text-sm" onSubmit={printOnPg}>
        <div className="flex items-center justify-center space-x-4">
          <div className="flex space-x-4">
            <input
              className="border-solid border-2 border-pink-600 rounded-md outline-none text-black"
              type="text"
            ...
            <input
              id="minProteinInput"
              className="border-solid border-2 border-pink-600 w-12 rounded-md outline-none  text-black"
              value={minProtein}
